!(function(t) {
  ...
  1: function(t, e, i) {
    ...
    var n = i(0)
    window && !window.VANTA && (window.VANTA = { version: '0.3.0' })
    ...
    ;(o.VantaBase = class {
      constructor(t = {}) {
        ...
        if (
          ...
          !(
            ...
            ((a = this.el), (this.el = Object(n.e)(a)), this.el)
          )
        )
          return void s('Cannot find element', a)
      ...
      applyBackgroundColor(t) {
        this.el.style.background = this.color2Hex(t)
      }
      initThree() {
      ...
      onMouseMoveWrapper(t) {
        ...
        if (
          ...
          (i = (t.clientX - e.left) / this.width),
          (n = (t.clientY - e.top) / this.height),
          i && n)
        )
          return (
            this.uniforms &&
              ((this.uniforms.u_mouse.value.x =
                (t.clientX - e.left) / this.scale),
              (this.uniforms.u_mouse.value.y =
                (t.clientY - e.top) / this.scale)),
            'function' == typeof this.onMouseMove
              ? this.onMouseMove(i, n)
              : void 0
          )
      }
      setSize() {
      ...
      animationLoop() {
        ...
        return (
          ...
          (i = e.top + s) - window.innerHeight <= s &&
            s <= i + t &&
  ...
  11: function(t, e, i) {
    ...
    class s extends n.b {
      ...
      onInit() {
        var t = (this.camera = new THREE.PerspectiveCamera(
          50,
        ...
        var e,
          ...
          a,
          h,
          l = (this.starsGeometry = new THREE.Geometry()),
          c = this.options.spacing
        for (e = n = -30; n <= 30; e = ++n)
          for (i = s = -30; s <= 30; i = ++s)
            ((r = new THREE.Vector3()).x = e * c + c / 2),
              (r.y = Object(o.g)(0, 5) - 150),
              (r.z = i * c + c / 2),
              l.vertices.push(r)
        ;(a = new THREE.PointsMaterial({
          color: this.options.color,
          size: this.options.size
        })),
          (h = this.starField = new THREE.Points(l, a)),
          this.scene.add(h)
      }
      onUpdate() {
        ...
        for (var e = 0; e < t.vertices.length; e++) {
          var i = t.vertices[e]
          i.y += 0.1 * Math.sin(0.02 * i.z + 0.015 * i.x + 0.02 * this.t)
        }
        t.verticesNeedUpdate = !0
        const n = this.camera
        ;(n.position.x += 0.003 * (n.tx - n.position.x)),
          (n.position.y += 0.003 * (n.ty - n.position.y)),
          (n.position.z += 0.003 * (n.tz - n.position.z)),
          n.lookAt(0, 0, 0)
      }
      onMouseMove(t, e) {
    ...
    s.initClass(), n.a.register('DOTS', s)
  }
})
